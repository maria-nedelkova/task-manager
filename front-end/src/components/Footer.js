        ...
        <footer className="footer">
            <div className="footer-info-container">
                ...
                <div id="contact">
                    ...
                    <p><FontAwesomeIcon icon={faEnvelope} className="footer-icon" />maria.nedelkova90@gmail.com</p>
                </div>
            </div>
            <div className="made-by">Made by
                <a className="linked-in-link" href="https://www.linkedin.com/in/maria-nedelkova-25497193/" target="_blank">Maria Nedelkova</a>
            </div>
        </footer>
    );
}